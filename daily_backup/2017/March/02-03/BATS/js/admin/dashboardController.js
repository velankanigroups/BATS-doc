batsAdminHome.controller('dashboardController', function($scope, $http, $rootScope,$localStorage,dashboardService){
	console.log("dashboard"); 
	$scope.token = $localStorage.data;
	$rootScope.menuPos=14;
	dashboardService.plotValues();
...
batsAdminHome.controller('dashboardTripController', function($scope, $http, $rootScope,$localStorage,dashboardService){
	console.log("trip"); 
	
	dashboardService.initMap()
